...
def detail(request,id):
    ...
    return render(request, 'market/detail.html',{'product':product,'stripe_publishable_key':stripe_publishable_key})
...
def payment_success_view(request):
    ...
    return render(request,'market/payment_success.html',{'order':order})
    
def payment_failed_view(request):
    return render(request,'market/failed.html')
...
def create_product(request):
    ...
    return render(request, 'market/create_product.html',{'product_form':product_form})
...
def product_edit(request,id):
    ...
    if request.method=='POST':
        if product_form.is_valid():
            product_form.save()
            return redirect('index')
    return render(request,'market/product_edit.html',{'product_form':product_form,'product':product})
...
def dashboard(request):
    ...
    return render(request, 'market/dashboard.html',{'products':products})
...
def invalid(request):
    return render(request, 'market/invalid.html')

def my_purchases(request):
    orders = OrderDetail.objects.filter(customer_email=request.user.email)
    return render(request, 'market/purchases.html',{'orders':orders})
...
def sales(request):
    ...
    return render(request, 'market/sales.html',{'total_sales':total_sales,'yearly_sales':yearly_sales,'monthly_sales':monthly_sales,'weekly_sales':weekly_sales,'daily_sales_sums':daily_sales_sums,'product_sales_sums':product_sales_sums})